...
def main(cmd_opt):
  ...
  for epoch in range(1, opt['epoch']):
    ...
    if epoch%20==0:
      get_model_data(model, dataset,epoch)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--dataset', type=str, default='shapenet',
                      help='Cora, Citeseer, Pubmed, Computers, Photo, CoauthorCS, ogbn-arxiv,shapenet')
  ...
  parser.add_argument("--shapenet_data", default='Cap', type=str,
                      help='Airplane,Bag,Cap,Car,Chair,Earphone,Guitar,Knife,Lamp,Laptop,Motorbike,Mug,Pistol,Rocket,Skateboard,Table')
